...
namespace PolyMod.RecommendationModule.Data.Configuration.Schedule;

public class ScheduleConfiguration : IEntityTypeConfiguration<PolyMod.ScheduleModule.Models.Schedule>
{
    public void Configure(EntityTypeBuilder<PolyMod.ScheduleModule.Models.Schedule> builder)
    {
